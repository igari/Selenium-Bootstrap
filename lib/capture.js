...
function Capture(selen) {
  this.driver = selen.driver;
  this.imagePathList = [];
  this.func2str = selen.func2str;
  this.executeScript = selen.executeScript;
  this.cap = selen.cap;
}
...
Capture.prototype = {
    ...
    return this.driver.takeScreenshot()
      .then(function (photoData) {
        return util.makeDir(fileName).then(function () {
          ...
          console.log('[saved]', `${fileName} (saveScreenshot)`);
        }.bind(this));
      }.bind(this));
  },
  saveFullScreenshot: function (imageFileName) {
    ...
    return this.executeScript(function () {
      ...
      .then(this.combineTempImages.bind(this, imageFileName))
      .then(this.deleteTempImages.bind(this))
      .then(function () {
        console.log('[saved]', `${imageFileName} (saveScreenshot)`);
      });
  },
  ...
  combineTempImages: function (imageFileName) {
    ...
    return this.generateHashPathList()
      ...
      .then(function (combineImage) {
        return this.saveCombineImage(imageFileName, combineImage)
      }.bind(this));
  },
